...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($method == "insert") {
        ...
        $sql = "INSERT INTO `library`.`student_id_password` VALUES ('$sid','$username')";
        if ($conn->query($sql)) {
...
<body>
    ...
    <form method="POST" class="insert-form" id="insert-form">
        ...
        <input class="form-control" name="sid" type="text" placeholder="Enter SID:" minlength="8" maxlength="8">
    ...
    <form method="POST" class="update-form" id="update-form">
        <h5>Update Data</h5>
        <input type="hidden" name="method" id="method-update" value="update">
        <input class="form-control" name="sid" type="text" placeholder="Enter SID of data to update :" minlength="8"
            maxlength="8">
    ...
    <form method="POST" class="conformUpdate-form" id="conformUpdate-form">
        ...
        <input type="hidden" name="method" id="method-conformUpdate" value="conformUpdate">
    ...
    <form method="POST" class="delete-form" id="delete-form">
        <h5>Delete Data</h5>
        <input type="hidden" name="method" id="method-delete" value="delete">
        <input class="form-control" name="sid" type="text" placeholder="Enter SID of data to delete :" minlength="8"
            maxlength="8">
    ...
    <form method="POST" class="conformDelete-form" id="conformDelete-form">
        ...
        <input type="hidden" name="method" id="method-conformUpdate" value="conformDelete">
        <button type="submit" class="btn btn-danger">Delete</button>
    </form>

    <form method="POST" class="search-form" id="search-form">
        <h5>Search</h5>
        <input type="hidden" name="method" id="method-search" value="search">
        <input class="form-control" name="sid" type="text" placeholder="Enter SID :" maxlength="8">
        <input class="form-control" name="username" type="text" placeholder="Enter Username :">
